...
@interface VZZXQRCodeAlignmentPattern ()

@property (nonatomic, assign, readonly) float estimatedModuleSize;

@end

@implementation VZZXQRCodeAlignmentPattern
...
- (VZZXQRCodeAlignmentPattern *)combineEstimateI:(float)i j:(float)j newModuleSize:(float)newModuleSize {
  ...
  return [[VZZXQRCodeAlignmentPattern alloc] initWithPosX:combinedX posY:combinedY estimatedModuleSize:combinedModuleSize];
}
