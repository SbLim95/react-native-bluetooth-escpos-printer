...
@class VZZXBitMatrix, VZZXQRCodeAlignmentPattern;
 ...
 */
@interface VZZXQRCodeAlignmentPatternFinder : NSObject
 ...
 *
 * @return VZZXAlignmentPattern if found or nil if not found
 */
