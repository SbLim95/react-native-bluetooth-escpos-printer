 ...
 */
@interface VZZXQRCodeFinderPattern : VZZXResultPoint
 ...
 * with a new estimate. It returns a new VZZXFinderPattern containing a weighted average
 * based on count.
 */
- (VZZXQRCodeFinderPattern *)combineEstimateI:(float)i j:(float)j newModuleSize:(float)newModuleSize;
