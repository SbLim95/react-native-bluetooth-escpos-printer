...
@class VZZXQRCodeVersion;

/**
 * See ISO 18004:2006, 6.4.1, Tables 2 and 3. This enum encapsulates the various modes in which
 * data can be encoded to bits in the QR code standard.
 */
@interface VZZXQRCodeMode : NSObject
...
+ (VZZXQRCodeMode *)terminatorMode; // Not really a mode...
+ (VZZXQRCodeMode *)numericMode;
+ (VZZXQRCodeMode *)alphanumericMode;
+ (VZZXQRCodeMode *)structuredAppendMode; // Not supported
+ (VZZXQRCodeMode *)byteMode;
+ (VZZXQRCodeMode *)eciMode; // character counts don't apply
