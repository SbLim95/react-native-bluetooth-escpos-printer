...
@interface VZZXCGImageLuminanceSource ()
...
@implementation VZZXCGImageLuminanceSource
...
- (id)initWithZXImage:(VZZXImage *)image
                 left:(size_t)left
                  top:(size_t)top
                width:(size_t)width
...
- (id)initWithBuffer:(CVPixelBufferRef)buffer
               ...
               width:(size_t)width
              height:(size_t)height {
  CGImageRef image = [VZZXCGImageLuminanceSource createImageFromBuffer:buffer left:left top:top width:width height:height];
...
- (id)initWithBuffer:(CVPixelBufferRef)buffer {
  CGImageRef image = [VZZXCGImageLuminanceSource createImageFromBuffer:buffer];
...
- (VZZXByteArray *)rowAtY:(int)y row:(VZZXByteArray *)row {
  ...
  if (!row || row.length < self.width) {
    row = [[VZZXByteArray alloc] initWithLength:self.width];
  }
...
- (VZZXLuminanceSource *)rotateCounterClockwise {
  ...
  VZZXCGImageLuminanceSource *result = [[VZZXCGImageLuminanceSource alloc] initWithCGImage:rotatedImage
                                                                                  left:self.top
...
- (VZZXLuminanceSource *)crop:(int)left top:(int)top width:(int)width height:(int)height {
  ...
  VZZXCGImageLuminanceSource *result = [[VZZXCGImageLuminanceSource alloc] initWithCGImage:croppedImageRef];
