 ...
 */
@interface VZZXParsedResult : NSObject

@property (nonatomic, assign, readonly) VZZXParsedResultType type;

- (id)initWithType:(VZZXParsedResultType)type;
+ (id)parsedResultWithType:(VZZXParsedResultType)type;
