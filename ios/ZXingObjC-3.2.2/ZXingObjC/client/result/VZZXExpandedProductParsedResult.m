...
NSString * const VZZX_KILOGRAM = @"KG";
NSString * const VZZX_POUND = @"LB";

@implementation VZZXExpandedProductParsedResult
...
- (BOOL)isEqual:(id)o {
  ...
  VZZXExpandedProductParsedResult *other = (VZZXExpandedProductParsedResult *)o;
