...
@implementation VZZXWifiParsedResult
...
- (NSString *)displayResult {
  ...
  [VZZXParsedResult maybeAppend:self.ssid result:result];
  [VZZXParsedResult maybeAppend:self.networkEncryption result:result];
  [VZZXParsedResult maybeAppend:self.password result:result];
  [VZZXParsedResult maybeAppend:[@(self.hidden) stringValue] result:result];
  return result;
}
