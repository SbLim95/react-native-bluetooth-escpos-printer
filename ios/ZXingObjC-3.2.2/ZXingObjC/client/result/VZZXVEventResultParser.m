...
@implementation VZZXVEventResultParser
...
- (VZZXParsedResult *)parse:(VZZXResult *)result {
  ...
  @try {
    return [VZZXCalendarParsedResult calendarParsedResultWithSummary:summary
                                                       startString:start
                                                         endString:end
...
- (NSString *)matchSingleVCardPrefixedField:(NSString *)prefix rawText:(NSString *)rawText trim:(BOOL)trim {
  NSArray *values = [VZZXVCardResultParser matchSingleVCardPrefixedField:prefix rawText:rawText trim:trim parseFieldDivider:NO];
...
- (NSMutableArray *)matchVCardPrefixedField:(NSString *)prefix rawText:(NSString *)rawText trim:(BOOL)trim {
  NSMutableArray *values = [VZZXVCardResultParser matchVCardPrefixedField:prefix rawText:rawText trim:trim parseFieldDivider:NO];
