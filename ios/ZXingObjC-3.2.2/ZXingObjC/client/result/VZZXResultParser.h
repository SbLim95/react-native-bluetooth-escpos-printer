...
@class VZZXParsedResult, VZZXResult;
 ...
 */
@interface VZZXResultParser : NSObject

/**
 * Attempts to parse the raw VZZXResult's contents as a particular type
 * of information (email, URL, etc.) and return a VZZXParsedResult encapsulating
