...
@implementation VZZXAddressBookParsedResult
...
- (NSString *)displayResult {
  ...
  [VZZXParsedResult maybeAppendArray:self.names result:result];
  [VZZXParsedResult maybeAppendArray:self.nicknames result:result];
  [VZZXParsedResult maybeAppend:self.pronunciation result:result];
  [VZZXParsedResult maybeAppend:self.title result:result];
  [VZZXParsedResult maybeAppend:self.org result:result];
  [VZZXParsedResult maybeAppendArray:self.addresses result:result];
  [VZZXParsedResult maybeAppendArray:self.phoneNumbers result:result];
  [VZZXParsedResult maybeAppendArray:self.emails result:result];
  [VZZXParsedResult maybeAppend:self.instantMessenger result:result];
  [VZZXParsedResult maybeAppendArray:self.urls result:result];
  [VZZXParsedResult maybeAppend:self.birthday result:result];
  [VZZXParsedResult maybeAppendArray:self.geo result:result];
  [VZZXParsedResult maybeAppend:self.note result:result];
  return result;
}
