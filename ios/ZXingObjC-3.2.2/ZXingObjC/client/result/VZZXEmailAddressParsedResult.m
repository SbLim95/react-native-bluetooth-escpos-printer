...
@implementation VZZXEmailAddressParsedResult
...
- (NSString *)displayResult {
  ...
  [VZZXParsedResult maybeAppendArray:self.tos result:result];
  [VZZXParsedResult maybeAppendArray:self.ccs result:result];
  [VZZXParsedResult maybeAppendArray:self.bccs result:result];
  [VZZXParsedResult maybeAppend:self.subject result:result];
  [VZZXParsedResult maybeAppend:self.body result:result];
  return result;
}
