...
@implementation VZZXExpandedProductResultParser
...
- (VZZXParsedResult *)parse:(VZZXResult *)result {
  ...
  return [VZZXExpandedProductParsedResult expandedProductParsedResultWithRawText:rawText
                                                                     productID:productID
                                                                          sscc:sscc
                                                                     lotNumber:lotNumber
