...
@implementation VZZXImage

- (VZZXImage *)initWithCGImageRef:(CGImageRef)image {
  if (self = [super init]) {
...
- (VZZXImage *)initWithURL:(NSURL const *)url {
  if (self = [super init]) {
...
+ (VZZXImage *)imageWithMatrix:(VZZXBitMatrix *)matrix {
  ...
  VZZXImage *result = [self imageWithMatrix:matrix onColor:black offColor:white];
...
+ (VZZXImage *)imageWithMatrix:(VZZXBitMatrix *)matrix onColor:(CGColorRef)onColor offColor:(CGColorRef)offColor {
  ...
  VZZXImage *zxImage = [[VZZXImage alloc] initWithCGImageRef:image];
