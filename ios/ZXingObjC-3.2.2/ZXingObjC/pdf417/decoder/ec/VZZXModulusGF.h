...
@class VZZXModulusPoly;

/**
 * A field based on powers of a generator integer, modulo some modulus.
 */
@interface VZZXModulusGF : NSObject

@property (nonatomic, strong, readonly) VZZXModulusPoly *one;
@property (nonatomic, strong, readonly) VZZXModulusPoly *zero;
