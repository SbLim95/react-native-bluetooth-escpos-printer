...
@class VZZXPDF417BarcodeMatrix, VZZXIntArray;

/**
 * Top-level class for the logic part of the PDF417 implementation.
 */
@interface VZZXPDF417 : NSObject

@property (nonatomic, strong, readonly) VZZXPDF417BarcodeMatrix *barcodeMatrix;
@property (nonatomic, assign) BOOL compact;
@property (nonatomic, assign) VZZXPDF417Compaction compaction;
 ...
 */
- (VZZXIntArray *)determineDimensions:(int)sourceCodeWords errorCorrectionCodeWords:(int)errorCorrectionCodeWords error:(NSError **)error;
