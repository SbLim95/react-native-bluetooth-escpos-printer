...
@implementation VZZXMaxiCodeDecodedBitStreamParser

+ (VZZXDecoderResult *)decode:(VZZXByteArray *)bytes mode:(int)mode {
...
+ (int)bit:(int)bit bytes:(VZZXByteArray *)bytes {
  bit--;
  return (bytes.array[bit / 6] & (1 << (5 - (bit % 6)))) == 0 ? 0 : 1;
}

+ (int)integer:(VZZXByteArray *)bytes x:(VZZXByteArray *)x {
  int val = 0;
...
+ (int)country:(VZZXByteArray *)bytes {
  return [self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:53, 54, 43, 44, 45, 46, 47, 48, 37, 38, -1]];
}

+ (int)serviceClass:(VZZXByteArray *)bytes {
  return [self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:55, 56, 57, 58, 59, 60, 49, 50, 51, 52, -1]];
}

+ (int)postCode2Length:(VZZXByteArray *)bytes {
  return [self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:39, 40, 41, 42, 31, 32, -1]];
}

+ (int)postCode2:(VZZXByteArray *)bytes {
  return [self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:33, 34, 35, 36, 25, 26, 27, 28, 29, 30, 19,
                                20, 21, 22, 23, 24, 13, 14, 15, 16, 17, 18, 7, 8, 9, 10, 11, 12, 1, 2, -1]];
}

+ (NSString *)postCode3:(VZZXByteArray *)bytes {
  return [NSString stringWithFormat:@"%C%C%C%C%C%C",
          SETS[0][[self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:39, 40, 41, 42, 31, 32, -1]]],
          SETS[0][[self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:33, 34, 35, 36, 25, 26, -1]]],
          SETS[0][[self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:27, 28, 29, 30, 19, 20, -1]]],
          SETS[0][[self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:21, 22, 23, 24, 13, 14, -1]]],
          SETS[0][[self integer:bytes x:[[VZZXByteArray alloc] initWithBytes:15, 16, 17, 18,  7,  8, -1]]],
          SETS[0][[self integer:bytes x:[[VZZXByteArray alloc] initWithBytes: 9, 10, 11, 12,  1,  2, -1]]]];
}

+ (NSString *)message:(VZZXByteArray *)bytes start:(int)start len:(int)len {
