...
@interface VZZXAztecBinaryShiftToken ()
...
@implementation VZZXAztecBinaryShiftToken

- (id)initWithPrevious:(VZZXAztecToken *)previous binaryShiftStart:(int)binaryShiftStart binaryShiftByteCount:(int)binaryShiftByteCount {
