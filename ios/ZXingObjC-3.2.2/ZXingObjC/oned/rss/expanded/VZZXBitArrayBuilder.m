...
@implementation VZZXBitArrayBuilder

+ (VZZXBitArray *)buildBitArray:(NSArray *)pairs {
  ...
  VZZXBitArray *binary = [[VZZXBitArray alloc] initWithSize:size];
  int accPos = 0;

  VZZXRSSExpandedPair *firstPair = pairs[0];
  ...
  for (int i = 1; i < [pairs count]; ++i) {
    VZZXRSSExpandedPair *currentPair = pairs[i];
