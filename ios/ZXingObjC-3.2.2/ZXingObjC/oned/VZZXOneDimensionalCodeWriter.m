...
@implementation VZZXOneDimensionalCodeWriter
 ...
 * VZZXBitMatrix when specified size is too small. The user can set both {width and
...
- (VZZXBitMatrix *)encode:(NSString *)contents format:(VZZXBarcodeFormat)format width:(int)width height:(int)height
  ...
  VZZXBoolArray *code = [self encode:contents];
 ...
 */
- (VZZXBitMatrix *)renderResult:(VZZXBoolArray *)code width:(int)width height:(int)height sidesMargin:(int)sidesMargin {
 ...
 */
- (int)appendPattern:(VZZXBoolArray *)target pos:(int)pos pattern:(const int[])pattern patternLen:(int)patternLen startColor:(BOOL)startColor {
 ...
 *
 * @return a VZZXBoolArray of horizontal pixels (false = white, true = black)
 */
