...
const int VZZX_UPCEAN_CHECK_DIGIT_ENCODINGS[] = {
  0x18, 0x14, 0x12, 0x11, 0x0C, 0x06, 0x03, 0x0A, 0x09, 0x05
};

@interface VZZXUPCEANExtension5Support ()

@property (nonatomic, strong, readonly) VZZXIntArray *decodeMiddleCounters;

@end

@implementation VZZXUPCEANExtension5Support
...
- (int)determineCheckDigit:(int)lgPatternFound {
  for (int d = 0; d < 10; d++) {
    if (lgPatternFound == VZZX_UPCEAN_CHECK_DIGIT_ENCODINGS[d]) {
      return d;
    }
  }
  return -1;
