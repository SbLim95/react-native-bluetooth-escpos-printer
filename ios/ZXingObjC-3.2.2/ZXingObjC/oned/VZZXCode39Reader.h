...
extern unichar VZZX_CODE39_ALPHABET[];
extern NSString *VZZX_CODE39_ALPHABET_STRING;
extern const int VZZX_CODE39_CHARACTER_ENCODINGS[];
 ...
 */
@interface VZZXCode39Reader : VZZXOneDReader
