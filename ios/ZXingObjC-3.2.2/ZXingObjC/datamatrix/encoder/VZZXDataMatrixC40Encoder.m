...
@implementation VZZXDataMatrixC40Encoder

- (int)encodingMode {
  return [VZZXDataMatrixHighLevelEncoder c40Encodation];
}
...
- (int)backtrackOneCharacter:(VZZXDataMatrixEncoderContext *)context buffer:(NSMutableString *)buffer
...
- (void)writeNextTriplet:(VZZXDataMatrixEncoderContext *)context buffer:(NSMutableString *)buffer {
 ...
 */
- (void)handleEOD:(VZZXDataMatrixEncoderContext *)context buffer:(NSMutableString *)buffer {
  int unwritten = ((int)buffer.length / 3) * 2;
  ...
  if (rest == 2) {
    ...
    if ([context hasMoreCharacters]) {
      [context writeCodeword:[VZZXDataMatrixHighLevelEncoder c40Unlatch]];
    }
  ...
  [context signalEncoderChange:[VZZXDataMatrixHighLevelEncoder asciiEncodation]];
}
