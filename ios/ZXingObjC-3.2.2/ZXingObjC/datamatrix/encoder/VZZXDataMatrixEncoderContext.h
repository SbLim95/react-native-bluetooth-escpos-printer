...
@class VZZXDataMatrixSymbolInfo, VZZXDimension;

@interface VZZXDataMatrixEncoderContext : NSObject
...
@property (nonatomic, assign) VZZXDataMatrixSymbolShapeHint symbolShape;
@property (nonatomic, strong) VZZXDataMatrixSymbolInfo *symbolInfo;
