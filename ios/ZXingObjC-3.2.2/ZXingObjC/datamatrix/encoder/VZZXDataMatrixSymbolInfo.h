 ...
 */
@interface VZZXDataMatrixSymbolInfo : NSObject
...
+ (VZZXDataMatrixSymbolInfo *)lookup:(int)dataCodewords shape:(VZZXDataMatrixSymbolShapeHint)shape minSize:(VZZXDimension *)minSize maxSize:(VZZXDimension *)maxSize fail:(BOOL)fail;
