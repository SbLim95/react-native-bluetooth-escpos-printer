...
#import "VZZXDataMatrixBase256Encoder.h"
#import "VZZXDataMatrixC40Encoder.h"
...
#import "VZZXDataMatrixTextEncoder.h"
#import "VZZXDataMatrixX12Encoder.h"
...
@implementation VZZXDataMatrixHighLevelEncoder

+ (void)initialize {
  if ([self class] != [VZZXDataMatrixHighLevelEncoder class]) return;
...
+ (NSString *)encodeHighLevel:(NSString *)msg {
  return [self encodeHighLevel:msg shape:VZZXDataMatrixSymbolShapeHintForceNone minSize:nil maxSize:nil];
}

+ (NSString *)encodeHighLevel:(NSString *)msg shape:(VZZXDataMatrixSymbolShapeHint)shape
                      minSize:(VZZXDimension *)minSize maxSize:(VZZXDimension *)maxSize {
  //the codewords 0..255 are encoded as Unicode characters
  NSArray *encoders = @[[[VZZXDataMatrixASCIIEncoder alloc] init],
                        [[VZZXDataMatrixC40Encoder alloc] init],
                        [[VZZXDataMatrixTextEncoder alloc] init],
                        [[VZZXDataMatrixX12Encoder alloc] init],
                        [[VZZXDataMatrixEdifactEncoder alloc] init],
                        [[VZZXDataMatrixBase256Encoder alloc] init]];

  VZZXDataMatrixEncoderContext *context = [[VZZXDataMatrixEncoderContext alloc] initWithMessage:msg];
