...
@implementation VZZXDataMatrixDecodedBitStreamParser

+ (void)initialize {
  if ([self class] != [VZZXDataMatrixDecodedBitStreamParser class]) return;

  memcpy(TEXT_SHIFT2_SET_CHARS, C40_SHIFT2_SET_CHARS, sizeof(C40_SHIFT2_SET_CHARS));
}

+ (VZZXDecoderResult *)decode:(VZZXByteArray *)bytes error:(NSError **)error {
 ...
 */
+ (int)decodeAsciiSegment:(VZZXBitSource *)bits result:(NSMutableString *)result resultTrailer:(NSMutableString *)resultTrailer {
  BOOL upperShift = NO;
  do {
 ...
 */
+ (BOOL)decodeC40Segment:(VZZXBitSource *)bits result:(NSMutableString *)result {
 ...
 */
+ (BOOL)decodeTextSegment:(VZZXBitSource *)bits result:(NSMutableString *)result {
 ...
 */
+ (BOOL)decodeAnsiX12Segment:(VZZXBitSource *)bits result:(NSMutableString *)result {
 ...
 */
+ (void)decodeEdifactSegment:(VZZXBitSource *)bits result:(NSMutableString *)result {
  do {
 ...
 */
+ (BOOL)decodeBase256Segment:(VZZXBitSource *)bits result:(NSMutableString *)result byteSegments:(NSMutableArray *)byteSegments {
  ...
  VZZXByteArray *bytes = [[VZZXByteArray alloc] initWithLength:count];
