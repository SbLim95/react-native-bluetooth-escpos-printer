 ...
 */
@interface VZZXDataMatrixECBlocks : NSObject
 ...
 */
@interface VZZXDataMatrixECB : NSObject
 ...
 */
@interface VZZXDataMatrixVersion : NSObject

@property (nonatomic, strong, readonly) VZZXDataMatrixECBlocks *ecBlocks;
