...
#define VZZXErrorDomain @"VZZXErrorDomain"
...
enum {
   ...
   */
  VZZXReaderError       = 1004,

  /**
   * Covers the range of error which may occur when encoding a barcode using the Writer framework.
   */
  VZZXWriterError       = 1005
};

// Helper methods for error instances
NSError *VZZXChecksumErrorInstance(void);
NSError *VZZXFormatErrorInstance(void);
NSError *VZZXNotFoundErrorInstance(void);
