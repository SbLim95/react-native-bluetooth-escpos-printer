 ...
 */
@interface VZZXBinarizer : NSObject

@property (nonatomic, strong, readonly) VZZXLuminanceSource *luminanceSource;
 ...
 *            If used, the Binarizer will call VZZXBitArray clear. Always use the returned object.
