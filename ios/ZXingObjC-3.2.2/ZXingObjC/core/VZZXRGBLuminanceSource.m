...
@interface VZZXRGBLuminanceSource ()

@property (nonatomic, strong, readonly) VZZXByteArray *luminances;
...
@implementation VZZXRGBLuminanceSource
...
- (id)initWithWidth:(int)width height:(int)height pixels:(int *)pixels pixelsLen:(int)pixelsLen {
  if (self = [super initWithWidth:width height:height]) {
    ...
    _luminances = [[VZZXByteArray alloc] initWithLength:width * height];
...
- (id)initWithPixels:(VZZXByteArray *)pixels dataWidth:(int)dataWidth dataHeight:(int)dataHeight
