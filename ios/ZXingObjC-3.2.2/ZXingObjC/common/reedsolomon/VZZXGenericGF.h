 ...
 */
@interface VZZXGenericGF : NSObject

@property (nonatomic, strong, readonly) VZZXGenericGFPoly *zero;
@property (nonatomic, strong, readonly) VZZXGenericGFPoly *one;
 ...
 */
- (VZZXGenericGFPoly *)buildMonomial:(int)degree coefficient:(int)coefficient;
