...
// For testing only
- (id)initWithBits:(VZZXIntArray *)bits size:(int)size {
...
- (void)appendBitArray:(VZZXBitArray *)other {
...
- (void)toBytes:(int)bitOffset array:(VZZXByteArray *)array offset:(int)offset numBytes:(int)numBytes {
...
- (VZZXIntArray *)bitArray {
  VZZXIntArray *array = [[VZZXIntArray alloc] initWithLength:self.bitsLength];
  memcpy(array.array, self.bits, array.length * sizeof(int32_t));
  return array;
}

- (BOOL)isEqual:(id)o {
  if (![o isKindOfClass:[VZZXBitArray class]]) {
    return NO;
  }
  VZZXBitArray *other = (VZZXBitArray *)o;
...
- (id)copyWithZone:(NSZone *)zone {
  VZZXBitArray *copy = [[VZZXBitArray allocWithZone:zone] initWithSize:self.size];
