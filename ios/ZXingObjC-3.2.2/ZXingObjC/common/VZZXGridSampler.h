...
@class VZZXBitMatrix, VZZXPerspectiveTransform;
 ...
 */
@interface VZZXGridSampler : NSObject
 ...
 */
+ (void)setGridSampler:(VZZXGridSampler *)newGridSampler;

/**
 * @return the current implementation of GridSampler
 */
+ (VZZXGridSampler *)instance;

/**
 * Samples an image for a rectangular matrix of bits of the given dimension.
 * @param image image to sample
 * @param dimensionX width of VZZXBitMatrix to sample from image
 * @param dimensionY height of VZZXBitMatrix to sample from image
 * @return VZZXBitMatrix representing a grid of points sampled from the image within a region
...
- (VZZXBitMatrix *)sampleGrid:(VZZXBitMatrix *)image
                 dimensionX:(int)dimensionX
                 dimensionY:(int)dimensionY
                  transform:(VZZXPerspectiveTransform *)transform
                      error:(NSError **)error;
 ...
 */
+ (BOOL)checkAndNudgePoints:(VZZXBitMatrix *)image points:(float *)points pointsLen:(int)pointsLen error:(NSError **)error;
