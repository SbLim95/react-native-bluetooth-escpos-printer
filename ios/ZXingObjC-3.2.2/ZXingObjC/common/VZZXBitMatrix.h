...
@class VZZXBitArray, VZZXIntArray;
 ...
 */
@interface VZZXBitMatrix : NSObject <NSCopying>
...
/**
 * Exclusive-or (XOR): Flip the bit in this VZZXBitMatrix if the corresponding
 * mask bit is set.
 *
 * @param mask XOR mask
 */
...
/**
 * A fast method to retrieve one row of data from the matrix as a VZZXBitArray.
 *
...
/**
 * @param y row to set
 * @param row VZZXBitArray to copy from
 */
- (void)setRowAtY:(int)y row:(VZZXBitArray *)row;

/**
 * Modifies this VZZXBitMatrix to represent the same but rotated 180 degrees
 */
- (void)rotate180;
